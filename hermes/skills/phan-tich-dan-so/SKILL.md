...
- **Đơn vị tiền tệ:** VND là mặc định. USD chỉ dùng cho mặt bằng thương mại / văn phòng (thông lệ thị trường). Theo quy ước trong kỹ năng `kien-truc-vn-rules` (mục tương ứng với `don-vi-do-luong.md`).
