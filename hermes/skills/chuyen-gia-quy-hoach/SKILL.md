...
description: "Chuyên gia quy hoạch mặt bằng — phân tích tổng hợp vị trí: môi trường/khí hậu, giao thông, dân số/thị trường, lịch sử/bối cảnh, di tích. Phù hợp khi người dùng cần đánh giá site-feasibility toàn diện trước khi đầu tư hoặc bắt đầu thiết kế."
version: 1.0.0
user-invocable: true
metadata:
  openclaw:
...
- **QCVN / TCVN, đơn vị đo lường, tuyên bố miễn trừ**: tất cả theo quy ước trong kỹ năng `kien-truc-vn-rules`.
- **Tuyên bố miễn trừ bắt buộc** ở đầu và cuối báo cáo tổng hợp (vì đây là tài liệu có thể gửi khách hàng).
