...
- Danh sách đầy đủ URL: xem `reference/ma-quy-hoach-hcm.md` (bundled in kỹ năng `kien-truc-vn-rules`)
...
- Xem đầy đủ mã: `reference/ma-quy-hoach-hcm.md` (bundled in kỹ năng `kien-truc-vn-rules`)
