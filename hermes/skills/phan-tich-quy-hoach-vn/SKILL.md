...
→ Danh sách đầy đủ: xem `reference/ma-quy-hoach-hcm.md` (bundled in kỹ năng `kien-truc-vn-rules`), mục 5
...
Luôn trình bày cả công thức và giá trị đầu vào (theo quy tắc quy ước trong kỹ năng `kien-truc-vn-rules` (mục tương ứng với `minh-bach.md`)).
...
- **Tuyên bố miễn trừ.** Đính kèm ở cuối (theo quy ước trong kỹ năng `kien-truc-vn-rules` (mục tương ứng với `tuyen-bo-mien-tru.md`)).
